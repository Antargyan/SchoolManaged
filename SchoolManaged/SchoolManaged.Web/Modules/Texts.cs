    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your SchoolManaged Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to School Managed";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your SchoolManaged Account";
                    ...
                    public static LocalText FormTitle = "Sign up for SchoolManaged";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "SchoolManaged";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText FooterCopyright = string.Format("Copyright (c) {0}.",System.DateTime.Now.Year);
                public static LocalText FooterInfo = "Powered by antargyan.com";
